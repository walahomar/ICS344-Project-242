...
### 🖼 Image 1: Login using username and password `vagrant`
![Login with vagrant](images/login_with_vagrant.png)

### 🖼 Image 2: Check the IP address using `ifconfig`
![Check IP address](images/ifconfig_output.png)

### 🖼 Image 3: Verify connection using `ping`
...
### 🖼 Image 4: Result of `nmap -p 22 192.168.56.101`
...
### 🖼 Image 5: Executing the exploit and opening SSH session
...
### 🖼 Image 6: Output of `whoami` inside the session
...
### 🖼 Image 7: Installing paramiko library
...
### 🖼 Image 8: Script success with correct password
