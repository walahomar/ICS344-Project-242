...
![Initial Splunk Config](images/Initial Splunk Configuration and Web Interface Launch on Kali Linux.png)

![Installing dpkg](images/Installing Splunk on Kali Linux using dpkg.png)
